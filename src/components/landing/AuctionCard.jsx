...
const AuctionCard = ({
  ...
  return (
    <div
      className="relative flex flex-col justify-between bg-white rounded-md overflow-hidden shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1"
      data-aos="zoom-in"
    >
      {/* Image */}
