...
const AddAuction = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (form.cover_image) {
                cover_image_url = await uploadImage(
                    form.cover_image,
                    "auction-covers"
                );
            }
            ...
            const gallery_urls = await Promise.all(
                form.gallery_images.map((file) =>
                    uploadImage(file, "auction-gallery")
                )
            );
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8">
            ...
            >
                ...
                <div className="bg-white p-6 rounded-xl shadow">
                    ...
                    <Field label="رفع الصورة الرئيسية">
